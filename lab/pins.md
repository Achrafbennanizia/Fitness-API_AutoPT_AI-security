...
| openGym | https://github.com/DuarteSantos8/openGym | `a68a88d2da04cf3334eeeca136385114a65450ff` | 2026-09-19 | Lab web Dockerfile: drop `--platform=$BUILDPLATFORM` (no Docker Buildx). Host bind `127.0.0.1:3102`. `RP_ID=127.0.0.1`. Passkey-only signup; two profiles not created this session. |
